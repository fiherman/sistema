...
function brn_guardar_doc(modo) {
    ...
    if (doc_nom != "" && doc_ape != "" && doc_cop != "" && doc_uni != ""){            
        ...
        if (doc_nom == "") { $("#txtadm_doc_nom").css({border: "1px solid red"}); }
        if (doc_ape == "") { $("#txtadm_doc_ape").css({border: "1px solid red"}); }
        if (doc_cop == "") { $("#txtadm_doc_cop").css({border: "1px solid red"}); }
        if (doc_uni == "") { $("#txtadm_doc_uni").css({border: "1px solid red"}); }
        if (doc_hab == "") { $("#txtadm_doc_hab").css({border: "1px solid red"}); }
...
function brn_guardar_especialidad(modo) {
    ...
    if (selected_val_1 != "select" && selected_val_2 != "select" && esp_des != "" && esp_cos != ""){            
        ...
        if (esp_des == "") { $("#div_adm_nueva_esp_des").css({border: "1px solid red"}); }
        if (esp_cos == "") { $("#div_adm_nueva_esp_cos").css({border: "1px solid red"}); }
        if (selected_val_1 == "select") { $("#div_adm_nueva_esp_seg").css({border: "1px solid red"}); }
        if (selected_val_2 == "select") { $("#div_adm_nueva_esp_tipo").css({border: "1px solid red"}); }
...
function btn_guardar_insert_usu(){
    ...
    if (nom_com != "" && email != "" && usuario != "" && pass != ""){
        ...
        if (nom_com == "") { $("#txt_divnuevousu_nomcom").css({border: "1px solid red"}); }
        if (email == "") { $("#txt_divnuevousu_email").css({border: "1px solid red"}); }
        if (usuario == "") { $("#txt_divnuevousu_user").css({border: "1px solid red"}); }
        if (pass == "") { $("#div_nuevo_usu_c").css({border: "1px solid red"}); }        
        mostraralertas('informe','* los campos marcados de rojo son requeridos','INFORMACION');
        return false;
    }
...
function btn_guardar_update_usu(){
    ...
    if (user_id != "" && nom_com != "" && email != "" && usuario != "" && pass != ""){
        ...
        if (nom_com == "") { $("#div_edit_usu_nom_com").css({border: "1px solid red"}); }
        if (email == "") { $("#div_edit_usu_email").css({border: "1px solid red"}); }
        if (usuario == "") { $("#div_edit_usu_user").css({border: "1px solid red"}); }
        if (pass == "") { $("#div_edit_usu_c_act").css({border: "1px solid red"}); }        
        mostraralertas('informe','* los campos marcados de rojo son requeridos','INFORMACION');
        return false;
    }
}
