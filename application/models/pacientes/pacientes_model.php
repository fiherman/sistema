...
class Pacientes_model extends CI_Model{
    ...
    function update_pacientes($id,$nom,$ape,$direc,$dni,$distri,$sexo,$fchnac,$tel=null,$movi=null,$claro=null,$email,$depen=null,$seg_id){
    ...
    function get_trat_tip($seg_id){
        return $this->db->query("SELECT esp_tip,esp_tip_des,esp_cod,esp_des,esp_cos_sol FROM especialidad where seg_id=$seg_id")->result();
    }
