        ...
        <div class="col-md-12 column">
            ...
            <div class="row clearfix" style="text-align: center;height: 150%">                
                <div class="col-md-4 column">
                    <a href="#" onclick="open_administracion();" class="list_group_item" style="opacity: 0.8;"><center><h1><b>ADMINISTRACI&Oacute;N</b></h1></center>
                        <img src="public/images/config2.png" class="img-rounded img-responsive" style="width: 58%;margin-left: 22%">
                    </a>
                </div>
                <div class="col-md-4 column">
                ...
                <div class="col-md-4 column">
                    <a href="#" onclick="fn_open_pac_rep();" style="opacity: 0.8;" class="list_group_item"><center><h1><b>REPORTES</b></h1></center>
...
include_once 'pacientes/reportes_view.php';
